...
public class FilterThree implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		System.out.println("FilterThree_init");
	}

	@Override
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {

		System.out.println("FilterThree_doFilter_start");
...
//		String servletPath = request1.getServletPath();
		...
		System.out.println("FilterThree_doFilter_end");
	}

	@Override
	public void destroy() {

		System.out.println("FilterThree_destroy");
	}
}
